...
export default function Page() {
  return (
    <>
      <Header />
      <div className="container my-[70px] mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          {/* Section gauche */}
          <div className="md:w-1/2 bg-white">
            <SocialIcons />

            <div className="bg-[#FDF8F5] rounded-lg shadow-md p-8 max-w-xl mx-auto">
              <h1 className="text-center text-5xl font-script text-[#53240f] mb-2">
                Monica Mariage
              </h1>

              {/* Carte avec les informations principales */}
              <div className="bg-white rounded-lg p-6 shadow-sm mb-2">
          ...
          <div className="relative md:w-1/2">
            <h2 className="mt-3 text-center text-2xl font-script text-[#53240f] mb-6">
              Où nous trouver
            </h2>
